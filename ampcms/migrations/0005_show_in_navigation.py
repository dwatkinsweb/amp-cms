...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Module.show_in_navigation'
        db.add_column('ampcms_module', 'show_in_navigation',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Page.show_in_navigation'
        db.add_column('ampcms_page', 'show_in_navigation',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Module.show_in_navigation'
        db.delete_column('ampcms_module', 'show_in_navigation')

        # Deleting field 'Page.show_in_navigation'
        db.delete_column('ampcms_page', 'show_in_navigation')
