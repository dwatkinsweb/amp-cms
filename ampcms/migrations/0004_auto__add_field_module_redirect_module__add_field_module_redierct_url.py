...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Module.redirect_module'
        db.add_column('ampcms_module', 'redirect_module',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['ampcms.Module'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Module.redirect_url'
        db.add_column('ampcms_module', 'redirect_url',
                      self.gf('django.db.models.fields.URLField')(default=None, max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Module.redirect_module'
        db.delete_column('ampcms_module', 'redirect_module_id')

        # Deleting field 'Module.redirect_url'
        db.delete_column('ampcms_module', 'redirect_url')
