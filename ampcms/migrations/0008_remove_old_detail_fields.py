...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('ampcms_module', 'title')

        # Deleting field 'Pagelet.title'
        db.delete_column('ampcms_pagelet', 'title')

        # Deleting field 'Pagelet.content'
        db.delete_column('ampcms_pagelet', 'content')

        # Deleting field 'Page.title'
        db.delete_column('ampcms_page', 'title')


    def backwards(self, orm):
        # Adding field 'Module.title'
        db.add_column('ampcms_module', 'title',
                      self.gf('django.db.models.fields.CharField')(default='UNSET', max_length=30),
                      keep_default=False)

        # Adding field 'Pagelet.title'
        db.add_column('ampcms_pagelet', 'title',
                      self.gf('django.db.models.fields.CharField')(default='UNSET', max_length=30),
                      keep_default=False)

        # Adding field 'Pagelet.content'
        db.add_column('ampcms_pagelet', 'content',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Page.title'
        db.add_column('ampcms_page', 'title',
                      self.gf('django.db.models.fields.CharField')(default='UNSET', max_length=30),
                      keep_default=False)
